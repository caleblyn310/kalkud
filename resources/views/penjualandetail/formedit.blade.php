...
<div class="form-group row">
    ...
    <div class="col-8">
        {!! Form::text('nominal_edit',null,['class'=>'form-control form-control-sm','maxlength'=>'10']) !!}
    ...
    <div class="col-8">
        {!! Form::text('diskon_edit',null,['class'=>'form-control form-control-sm','maxlength'=>'10']) !!}
        <!--<p class="errorNominal text-center alert alert-danger hidden"></p>-->
    </div>
    </div>
    <div class="form-group row">
    ...
    <div class="col-8">
        {!! Form::text('hrg_sat_edit',null,['class'=>'form-control form-control-sm','placeholder'=>'0','readonly'=>'']) !!}
        <!--<p class="errorNominal text-center alert alert-danger hidden"></p>-->
    </div>
</div>
    </div>
