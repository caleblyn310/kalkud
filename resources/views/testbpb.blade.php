...
@section('content')
    <div class="container">
        <div class="row" style="padding-top: 25px;">
            ...
            <div class="card">
                <div class="card-body"><h6>Bukti</h6>
...
<div class="form-group row">
    ...
    <div class="col-3 form-group">
        ...
        {!! Form::text('invoices_no',$invno,['class'=>'form-control form-control-sm','id' => 'invoices_no','placeholder'=>'Invoice Number...','required'=>'','maxlength'=>'5', 'readonly']) !!}</div>
        </div><hr>
</div>
