	...
	<div class="container">
        <div class="row" style="padding-top: 25px;">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    {!! Form::open (['url'=>'testingan','files'=>true]) !!}
						<div class="form-group row">
						    {!! Form::label('nisn_siswa','NISN Siswa',['class'=>'col-md-3 form-control-label']) !!}
						    <div class="col-md-9"><input type="text" name="nisn_siswa" multiple class="form-control-sm form-control" /></div>
						    </br>
						</div>
