...
<div class="row"> 
    ...
    {!! Form::text('No_bukti',null,['class'=>'form-control','placeholder'=>'Slip no','required'=>'']) !!}&nbsp;
...
@endif
    ...
    <div class="col-6">
        {!! Form::text('qq', '', ['class'=>'form-control','id' =>  'qq', 'placeholder' =>  'Cari kode d-ger', 'autofocus'=>'', 'maxlength' => '10']) !!}</div>
        <div class="col-3"> 
        {!! Form::text('No_account',null,['class'=>'form-control','placeholder'=>'KODE D-Ger',
...
<div class="form-group row">
    ...
    <div class="col-9">
        {!! Form::text('Uraian',null,['class'=>'form-control','placeholder'=>'Deskripsi','required'=>'','maxlength'=>'150']) !!}
    </div>
</div>
...
<div class="form-group row">
    ...
    <div class="col-4">
        {!! Form::text('Debet',!empty($jurnaladmin) ? substr($jurnaladmin->Debet,0,-3) : 0, ['class'=>'form-control','placeholder'=>'Debet','required'=>'','maxlength'=>'15']) !!}</div>
    <div class="col-4">    
        <span id="errmsg"></span>
    </div>
</div>
...
<div class="form-group row">
    ...
    <div class="col-4">
        {!! Form::text('Kredit',!empty($jurnaladmin) ? substr($jurnaladmin->Kredit,0,-3) : 0, ['class'=>'form-control','placeholder'=>'Kredit','maxlength'=>'15','required'=>'']) !!}</div>
    <div class="col-4">
...
@endif
    ...
    <div class="col-6">
        {!! Form::text('q2', '', ['class'=>'form-control','id' => 'q2', 'placeholder' =>  'Cari kode d-ger',
        'autofocus'=>'']) !!}</div>
    <div class="col-3"> 
        {!! Form::text('Kontra_acc',null,['class'=>'form-control','placeholder'=>'KODE D-Ger',
