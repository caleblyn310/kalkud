    ...
    <div class="container table-responsive">
        <div class="row">
            <div class="tomb text-right btn-group-vertical" style="width: 80px; height: auto;">
                <a href="create" class="btn btn-sm btn-info btn-block">ADD</a>
            </div>
        ...
        @if (!empty($daftar_pembelian))
            <table class="table table-striped table-bordered table-hover table-condensed table-sm" id="tblKaskcl">
                <caption style="caption-side: top;color: #171717;"><strong>Daftar Pembelian Kantin</strong></caption>
                <thead><tr>
                    <th>Tanggal</th><th>Supplier</th><th>Inv. No</th><th>Nominal</th><th style="width: 77px;">Action</th>
                </tr></thead>
                <tbody>
                <?php $total = 0 ?>
